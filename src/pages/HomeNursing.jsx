...
const HOME_NURSING_STYLESHEETS = [
...
const HOME_NURSING_INLINE_CSS = `:root {
...
export const HomeNursing = () => {
  useEffect(() => {
    document.title = "Home Nursing | L.T Way to Healthcare";

    HOME_NURSING_STYLESHEETS.forEach((href) => {
      const existing = document.querySelector(`link[data-home-nursing-css="${href}"]`);
      if (existing) return;

      const link = document.createElement("link");
      link.rel = "stylesheet";
      link.href = href;
      link.setAttribute("data-home-nursing-css", href);
  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{ __html: HOME_NURSING_INLINE_CSS }} />
      ...
      <div className="page-wrapper">
        ...
        <section className="section hero">
            <div className="container hero-grid">
                <div>
                    <span className="eyebrow">Home Nursing</span>
                    <h1>Compassionate Home Nursing Care</h1>
                    <p>
                        Receive professional, personalized medical and nursing support from our certified team, all in the comfort of your own home.
                    </p>
                    <ul className="hero-list">
                        <li>Certified nurses — highly skilled, licensed nursing professionals</li>
                        <li>Customized care plans tailored to your health needs and goals</li>
                        <li>Flexible scheduling that fits your daily routine</li>
                    </ul>
                    <p style={{marginTop: '18px'}}>
                        <a className="btn btn-primary" href="contact.html">Request Admission Information</a>
                    </p>
                </div>
                <div className="hero-box">
                    <h3>Your Health is Our Priority</h3>
                    <p style={{marginTop: '8px'}}>
                        We bring professional nursing care directly to your home, ensuring comfort, dignity, and personalized attention. Our services are designed to support your recovery and well-being with compassionate care.
                    </p>
                    <div className="grid-2" style={{marginTop: '16px'}}>
                        <div className="card">
                            <div className="lt-icon"><img src="/assets/images/icon/surgery.png" alt="" style={{height: '50px', width: '50px'}} /></div>
                            <h3>Post-Operative Care</h3>
                            <p>Expert care for a smooth and comfortable recovery after surgery.</p>
                        </div>
                        <div className="card">
                            <div className="lt-icon"><img src="/assets/images/icon/pain.png" alt="" style={{height: '50px', width: '50px'}} /></div>
                            <h3>Chronic Disease Care</h3>
                            <p>Specialized support for conditions like diabetes, COPD, and heart disease.</p>
                        </div>
                        <div className="card">
                            <div className="lt-icon"><img src="/assets/images/icon/elderly.png" alt="" style={{height: '50px', width: '50px'}} /></div>
                            <h3>Elderly &amp; Palliative Care</h3>
                            <p>Compassionate nursing care and support for seniors and those with limited mobility.</p>
                        </div>
                        <div className="card">
                            <div className="lt-icon"><img src="/assets/images/icon/neuron.png" alt="" style={{height: '50px', width: '50px'}} /></div>
                            <h3>Advanced Wound Care</h3>
                            <p>Professional wound assessment, cleaning, and dressing at home.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section className="section">
            <div className="container">
                ...
                <h2>The At-Home Nursing Advantage</h2>
                <p style={{maxWidth: '760px', margin: '0 auto 8px', textAlign: 'center', color: '#5a6b7a'}}>Discover the significant benefits of receiving compassionate and professional nursing care in the place you feel most comfortable—your home.</p>
                <div className="grid-3" style={{marginTop: '16px'}}>
                    <article className="card">
                        <h3>Unmatched Convenience</h3>
                        <p>Eliminate the stress and time of travel to a clinic. Our certified nurses provide expert care at your doorstep, on your schedule.</p>
                    </article>
                    <article className="card">
                        <h3>Focused, One-on-One Care</h3>
                        <p>Your dedicated nurse provides undivided attention, creating a personalized care plan that adapts to your environment and evolving needs.</p>
                    </article>
                    <article className="card">
                        <h3>Healing in a Familiar Space</h3>
                        <p>Recover and manage your health with greater peace of mind. Your home environment promotes comfort, reduces anxiety, and can lead to faster healing.</p>
                    </article>
                </div>
            </div>
        </section>
        ...
        <section className="section section-soft">
            <div className="container">
                ...
                <p>We've created a straightforward and supportive process to begin your journey to comprehensive home nursing care.</p>
                <div className="grid-4" style={{marginTop: '18px'}}>
                    <article className="card step">
                        <div className="step-number">1</div>
                        <h3>Initial Consultation</h3>
                        <p>A friendly call to understand your needs and discuss how our services can help.</p>
                    </article>
                    <article className="card step">
                        <div className="step-number">2</div>
                        <h3>In-Home Assessment</h3>
                        <p>A nurse visits to conduct a detailed evaluation of the patient's condition and environment.</p>
                    </article>
                    <article className="card step">
                        <div className="step-number">3</div>
                        <h3>Personalized Care Plan</h3>
                        <p>We collaborate with you and your family to design a custom care plan with clear goals.</p>
                    </article>
                    <article className="card step">
                        <div className="step-number">4</div>
                        <h3>Consistent, Quality Care</h3>
                        <p>Our professional nurses begin providing care, with regular follow-ups to ensure continuous improvement.</p>
                    </article>
                </div>
            </div>
        </section>
        ...
        <section className="section">
            <div className="container">
                ...
                <h2>Stories of Healing and Care</h2>
                <p style={{maxWidth: '720px', margin: '0 auto 8px', textAlign: 'center', color: '#5a6b7a'}}>Read what our clients and their families have to say about our compassionate home nursing services.</p>
                <div className="grid-3" style={{marginTop: '18px'}}>
                    <article className="card testimonial">
                        <p>"The peace of mind knowing my father was receiving expert care at home in Bhubaneswar was priceless. The nurse was not only professional but incredibly kind and patient."</p>
                        <span className="name">S. Kar</span>
                        <span className="meta">Family Member, Bhubaneswar</span>
                    </article>
                    <article className="card testimonial">
                        <p>"After my operation, I needed professional wound care at home. The nurse from this service was a lifesaver. She was meticulous, gentle, and explained every step. A fantastic service!"</p>
                        <span className="name">J. Patra</span>
                        <span className="meta">Patient, Cuttack</span>
                    </article>
                    <article className="card testimonial">
                        <p>"Their home nursing for my elderly mother has been a game-changer. The nurse's empathy and professional expertise have greatly improved her quality of life and my peace of mind."</p>
                        <span className="name">R. Mohanty</span>
                        <span className="meta">Family Member, Puri</span>
                    </article>
                </div>
            </div>
        </section>
        ...
        <section className="section section-soft">
            <div className="container">
                ...
                <p style={{maxWidth: '720px', margin: '0 auto 8px', textAlign: 'center', color: '#5a6b7a'}}>Here are answers to some common questions. If you have others, please don't hesitate to contact us.</p>
                <div style={{marginTop: '18px'}}>
                    <details className="faq-item" open>
                        <summary>What services does a home nurse provide?</summary>
                        <p className="faq-answer">Our home nurses provide a wide range of services, including medication administration, wound care, post-operative support, vital sign monitoring, and management of chronic diseases like diabetes and hypertension.</p>
                    </details>
                    <details className="faq-item">
                        <summary>Are your nurses certified and experienced?</summary>
                        <p className="faq-answer">Yes. All our nurses are fully licensed and hold relevant certifications. They have extensive experience in providing professional, compassionate care in home environments.</p>
                    </details>
                    <details className="faq-item">
                        <summary>Do you offer 24/7 home nursing care?</summary>
                        <p className="faq-answer">We offer flexible scheduling, including hourly, daily, and long-term care plans. For specific needs, please contact us for a consultation to discuss your requirements.</p>
                    </details>
                    <details className="faq-item">
                        <summary>How do you manage patient safety at home?</summary>
                        <p className="faq-answer">Patient safety is our top priority. Our nurses follow strict protocols, and we conduct thorough in-home assessments to identify and mitigate any potential risks. We also maintain clear communication with family members.</p>
                    </details>
                </div>
            </div>
        </section>
        ...
        <NewsletterSection
            id="consultation"
            title="Ready to Discuss a Compassionate Care Plan?"
            text="Our expert geriatric team is here to provide the compassionate and specialized care your loved one deserves. Contact us today to discuss admission or book a consultation."
        />
        {/* Newsletter One End */}
