...
export const Home = () => {
    ...
    useEffect(() => {
        ...
        const onDown = () => {
            ...
            cursorDot.classList.add("custom-cursor__innerhover");
        };

        const onUp = () => {
            cursor.classList.remove("click");
            cursorDot.classList.remove("custom-cursor__innerhover");
        };
  ...
  <style>{`
    ...
    `}</style>
  <div ref={customCursorRef} className="custom-cursor__cursor" />
  <div ref={customCursorDotRef} className="custom-cursor__cursor-two" />
